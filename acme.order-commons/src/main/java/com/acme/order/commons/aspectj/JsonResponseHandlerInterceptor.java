package com.acme.order.commons.aspectj;
...
import com.acme.order.commons.response.HeaderDto;
...
public class JsonResponseHandlerInterceptor implements HandlerInterceptor
{
   ...
   * 
   */
  @Around("execution (* com.acme.order.controller.*.*(..))"
      + " and @annotation(com.acme.order.commons.aspectj.JsonResponseInterceptor)")
